...
from ..components.i3d import get_padding_shape, Unit3Dpy
...
class I3D(torch.nn.Module):
    def __init__(self,
        ...
        self.maxPool3d_2a_3x3 = MaxPool3dTFPadding(
            kernel_size=(1, 3, 3), stride=(1, 2, 2), padding='SAME')   # [2, 4]
        # conv conv
        ...
        self.maxPool3d_3a_3x3 = MaxPool3dTFPadding(
            kernel_size=(1, 3, 3), stride=(1, 2, 2), padding='SAME')    # [2, 8, 8]
        ...
        self.maxPool3d_4a_3x3 = MaxPool3dTFPadding(
            kernel_size=(3, 3, 3), stride=(2, 2, 2), padding='SAME')    # [4, 16, 16]
        ...
        self.maxPool3d_5a_2x2 = MaxPool3dTFPadding(
            kernel_size=(2, 2, 2), stride=(2, 2, 2), padding='SAME')    # [8, 32, 32]
    ...
    def stem_forward(self, inp, txt=None, spatials=None):
        # Preprocessing
        res = []
        out = self.conv3d_1a_7x7(inp)
        if self.skip_connect == 'single':
            res.append(out[:, :, 2, :, :])
        elif self.skip_connect == 'mean':
            res.append(out.mean(2))
        elif self.skip_connect == 'all':
            res.append(out)
        
        out = self.maxPool3d_2a_3x3(out)   # [64]
        ...
        out = self.maxPool3d_3a_3x3(out)    # [192]
        ...
        out = self.maxPool3d_4a_3x3(out)    # [480]
        ...
        out = self.maxPool3d_5a_2x2(out)    # [832]
        out = self.mixed_5b(out)
        out = self.mixed_5c(out)     # [1024]
